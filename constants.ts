...
export const PROJECT_DATA: Record<string, Project> = {
  ...
  wfp: {
      ...
      context: "A Randomized Controlled Trial (RCT) and multi-country validation study auditing the integrity of remote financial & food security data infrastructure.",
      stack: ["Python", "R", "Stata", "Statistical analysis", "Econometrics"],
      what: "Analyzed experimental data from 4,000+ households and harmonized 150K+ legacy records to stress-test the accuracy of high-stakes remote monitoring protocols.",
      how: "Engineered forensic validation pipelines using measurement error in expenditure data. Deployed regression interaction models to isolate 'mode effects' (e.g., social desirability bias) from actual economic distress.",
      impact: "Prevented potential misallocation of humanitarian capital by revealing a 67-percentage-point divergence in emergency metrics between survey modes. Disproved the viability of universal statistical adjustments in favor of context-specific validation.",
