...
export const PROJECT_DATA: Record<string, Project> = {
    nova: {
        ...
        impact: "Won the $20,000 Prize for 'Best Business Value'. The solution demonstrated forward-looking leadership at the intersection of AI and Operations, influencing senior leadership decisions.",
