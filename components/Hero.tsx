...
const Hero: React.FC = () => {
  ...
  const baseText = "ECONOMIST // COMPUTER SCIENTIST // PRODUCT STRATEGIST // PYTHON // STATA // SQL // AGENTIC AI // IMPACT MODELING // RESILIENCE // ";
            ...
            <div className="flex flex-wrap gap-x-4 md:gap-x-8">
                {lineTwo.map((text, i) => (
                    <motion.div
                        ...
                        className="overflow-hidden"
                    >
                        <span className={`inline-block ${i === 1 ? 'text-pop' : ''}`}>
                            {text}
                        </span>
                    </motion.div>
                ))}
