      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative group cursor-hoverable">
          ...
          <div className="relative bg-white dark:bg-zinc border border-ink dark:border-white p-2 aspect-[4/5] overflow-hidden">
            <img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&q=80&w=800" alt="Pamimo" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" />
